...
Route::controller('PersonController')
    ...
    ->middleware('auth')->group( function(){
        ...
        Route::delete('/{person}/delete', 'destroy')->name('.delete');
});

Route::controller('BusinessController')
    ...
    ->middleware('auth')->group( function(){
        ...
        Route::delete('/{business}/delete', 'destroy')->name('.delete');
    });

Route::controller('TaskController')
    ->prefix('task')->name('task')
    ->middleware('auth')->group(function(){
        Route::get('/', 'index')->name('.index');
        Route::post('/store', 'store')->name('.store');
