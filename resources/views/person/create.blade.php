        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="font-semibold pb-3"> Add a new person </h3>
                    <form method="POST" action="{{route('person.store')}}">
                        ...
                        <div class="grid md:grid-cols-2 sm:grid-cols-6 gap-6">
                            ...
                            <span class="sm:col-span-3">
                                ...
                                <input class="block w-full" type="text" name="first_name" id="firstname" value="{{old('first_name')}}">
                            </span>

                            <span class="sm:col-span-3">
                                <label class="block" for="lastname">Last Name</label>
                                <input class="block w-full" type="text" name="last_name" id="lastname" value="{{old('last_name')}}">
                            </span>
                            ...
                            <span class="sm:col-span-3">
                                ...
                                <option value="" selected> --Choose a business-- </option>
                        ...
                        <div class="mt-6 flex items-center justify-end gap-6">
                            ...
                            <button type="submit" class="bg-red-800 text-white py-2 px-3 rounded-full">Save</button>
                        </div>
                    </form>
